...
const replacements = [
    ...
    // Milestone modal
    ["bg-white border-4 border-black w-full max-w-sm shadow-[8px_8px_0_0_rgba(0,0,0,1)]", "bg-white border border-slate-100 rounded-2xl w-full max-w-sm shadow-2xl"],
    ...
    ["px-4 py-2 border-2 transition-colors ${editMilestoneDraft.icon !== 'flag' ? 'border-black bg-slate-50 shadow-[2px_2px_0_0_rgba(0,0,0,1)]' : 'border-black/20 hover:bg-slate-50'}", "px-4 py-2 border rounded-md transition-colors ${editMilestoneDraft.icon !== 'flag' ? 'border-blue-500 ring-2 ring-blue-500/20 bg-blue-50' : 'border-slate-200 hover:bg-slate-50'}"],
    ["w-3 h-3 bg-white border border-black rotate-45", "w-3 h-3 bg-white border border-slate-400 shadow-sm rotate-45"],
    ["px-4 py-2 border-2 transition-colors ${editMilestoneDraft.icon === 'flag' ? 'border-black bg-slate-50 shadow-[2px_2px_0_0_rgba(0,0,0,1)]' : 'border-black/20 hover:bg-slate-50'}", "px-4 py-2 border rounded-md transition-colors ${editMilestoneDraft.icon === 'flag' ? 'border-blue-500 ring-2 ring-blue-500/20 bg-blue-50' : 'border-slate-200 hover:bg-slate-50'}"],
    ["border-2 hover:bg-slate-50 transition-colors ${editMilestoneDraft.color === c.value || (!editMilestoneDraft.color && c.value === '#dc2626') ? 'border-black bg-slate-50 shadow-[2px_2px_0_0_rgba(0,0,0,1)]' : 'border-black/20'}", "border rounded-md hover:bg-slate-50 transition-all ${editMilestoneDraft.color === c.value || (!editMilestoneDraft.color && c.value === '#dc2626') ? 'border-blue-500 ring-2 ring-blue-500/20 bg-slate-50 shadow-sm' : 'border-slate-200'}"],
